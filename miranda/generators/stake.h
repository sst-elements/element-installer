...
namespace SST {
    namespace Miranda {
        ...
        public:
            ...
            { "bin", "Set the RISC-V ELF binary", "nullptr" },
            { "args", "Set the RISC-V binary arguments", "nullptr" },
            { "extension", "Specify the RoCC extension", "nullptr" },
            { "extlib", "Shared library to load", "nullptr" }
            )

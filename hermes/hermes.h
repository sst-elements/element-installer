    ...
    switch ( lh.getType() ) {\
      ...
      default:\
        ...
        public:
            ...
            MemAddr(Type type = Normal) : type(type), simVAddr(0), backing(nullptr) {}
        ...
        public:
            ...
            virtual NodePerf *getNodePerf() { return nullptr; }

            virtual Thornhill::DetailedCompute *getDetailedCompute() { return nullptr; }

            virtual Thornhill::MemoryHeapLink *getMemHeapLink() { return nullptr; }
        };

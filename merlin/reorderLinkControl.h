...
// Need our own version of Request to add a sequence number
        ...
        public:
            ...
            //                size_t size_in_bits, bool head, bool tail, uint32_t seq, Event* payload = nullptr) :
            ...
            typedef std::priority_queue<ReorderRequest *,
                std::vector < ReorderRequest * >, Priority>
            PriorityQueue;
        ...
        struct ReorderInfo {
            ...
            ReorderInfo() :
                send(0),
                recv(0) {
                // Put a dummy entry into queue to avoid checks for nullptr later

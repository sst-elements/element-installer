...
namespace SST {
    namespace Merlin {
        ...
        public:
            ...
            { "translator", "Translator backend.  Inherit from SST::Merlin::Bridge::Translator.", nullptr },
            ...
            SimpleNetwork::nid_t getAddrForNetwork(
                uint8_t netID) { return interfaces[netID].getAddr(); }
            ...
            public:
                 ...
                 *
                 * Return nullptr if the packet should be be forwarded.
                 */
                virtual SimpleNetwork::Request *translate(SimpleNetwork::Request *req,
                                                          uint8_t fromNetwork) = 0;
                 ...
                 * Return nullptr if the packet should be be forwarded.
                 */
                virtual SimpleNetwork::Request *initTranslate(SimpleNetwork::Request *req,
                                                              uint8_t fromNetwork) = 0;

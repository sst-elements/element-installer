...
namespace SST {
    ...
    namespace Merlin {
        ...
        ReorderLinkControl::ReorderLinkControl(Component *parent, Params &params) :
            ...
            link_control = static_cast<SST::Interfaces::SimpleNetwork *>(loadSubComponent(networkIF,
                                                                                          params));
        }
        ...
        ReorderLinkControl::setup() {
            ...
            link_control->setNotifyOnReceive(
                new SST::Interfaces::SimpleNetwork::Handler<ReorderLinkControl>(this,
                                                                                &ReorderLinkControl::handle_event));
        }

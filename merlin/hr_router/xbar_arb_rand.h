    ...
    namespace Merlin {
        ...
        private:
            ...
            public:
                ...
                inline bool operator()(const priority_entry_t *lhs,
                                       const priority_entry_t *rhs) const {
            ...
            typedef std::priority_queue<priority_entry_t *,
                std::vector < priority_entry_t * >, xbar_arb_rand::rand_priority>
            rand_queue_t;

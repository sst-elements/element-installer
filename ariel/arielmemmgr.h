        ...
        public:
            ...
            ArielMemoryManager(Component *comp, Params &params) : SubComponent(comp) {
                ...
                output->fatal(CALL_INFO, -1,
                              "Error: ArielMemoryManager subcomponents do not support loading using legacy load functions");
            }
            ...
            virtual bool allocateMalloc(const uint64_t size, const uint32_t level,
                ...
                output->verbose(CALL_INFO, 4, 0,
                                "The instantiated ArielMemoryManager does not support malloc handling.\n");
                return false;
            }
            ...
            virtual bool allocateMMAP(const uint64_t size, const uint32_t level,
                ...
                output->verbose(CALL_INFO, 4, 0,
                                "The instantiated ArielMemoryManager does nto support MMAP handling.\n");
                return false;
            }

            virtual void freeMMAP(const uint32_t file) {
                output->verbose(CALL_INFO, 4, 0,
                                "The instantiated ArielMemoryManager does not support MMAP handling.\n");
            }

...
#define STRINGIZE(input) #input
        ...
        public:
            ...
            /* SST ELI */
            SST_ELI_REGISTER_COMPONENT(ArielCPU,
            "ariel", "ariel", SST_ELI_ELEMENT_VERSION(1,0,0), "PIN-based CPU model", COMPONENT_CATEGORY_PROCESSOR)
            ...
            {
                "launcher", "Specify the launcher to be used for instrumentation, default is path to PIN", STRINGIZE(
                    PINTOOL_EXECUTABLE)
            },

...
for next_group in range(groups):
    ...
    for next_active_core in range(active_cores_per_group):
        ...
        ariel_cache_link.connect((ariel, "cache_link_" + str(next_core_id), ring_latency),
    ...
    for next_l3_cache_block in range(l3cache_blocks_per_group):
        ...
        l3cache = sst.Component("l3cache" + str((next_group * l3cache_blocks_per_group) + next_l3_cache_block),
                                "memHierarchy.Cache")

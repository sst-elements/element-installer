 ...
 */
        ...
        public:
            ...
            enum class InitCommand {
                Region, Data, Coherence
            };

            /* Init event */
            MemEventInit(std::string src, InitCommand cmd) : MemEventBase(src, Command::nullptrCMD),
                                                             initCmd_(cmd) {}
        ...
        public:
            ...
            MemEventInitCoherence(std::string src, Endpoint type, bool inclusive, bool WBAck,
                                  Addr lineSize, bool tracksPresence) :
                MemEventInit(src, InitCommand::Coherence), type_(type), inclusive_(inclusive),
                needWBAck_(WBAck), lineSize_(lineSize), tracksPresence_(tracksPresence) {}
            ...
            virtual std::string getVerboseString() override {
                std::ostringstream str;
                str << " Type: " << (int) type_ << " Inclusive: "
                    << (inclusive_ ? "true" : "false");
                str << " LineSize: " << lineSize_ << " Tracks presence: "
                    << (tracksPresence_ ? "true" : "false");
        ...
        public:
            ...
            virtual std::string getVerboseString() override {
                return MemEventInit::getVerboseString() + region_.toString() + " SetRegion: " +
                       (setRegion_ ? "T" : "F");
            }

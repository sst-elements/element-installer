...
/* Element Library Info */
            SST_ELI_REGISTER_COMPONENT(DirectoryController,
            "memHierarchy", "DirectoryController", SST_ELI_ELEMENT_VERSION(1,0,0),
            ...
            {
                "network", "Link to network; doubles as request network for split networks", {
                    "memHierarchy.MemRtrEvent"}
            },
            {
                "network_ack", "For split networks, link to response/ack network", {
                    "memHierarchy.MemRtrEvent"}
            },
            {
                "network_fwd", "For split networks, link to forward request network", {
                    "memHierarchy.MemRtrEvent"}
            },
            {
                "network_data", "For split networks, link to data network", {
                    "memHierarchy.MemRtrEvent"}
            })

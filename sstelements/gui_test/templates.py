...
class SSTElementWindow(QtWidgets.QMainWindow):
    ...
    def add_back_btn(self):
        ...
        self.__hlayout.addWidget(self.back_btn)
        self.back_btn.clicked.connect(self.__on_back_clicked)

    def add_exit_btn(self):

        self.exit_btn = QtWidgets.QPushButton("❌ Exit")
        self.exit_btn.setStyleSheet("background-color: #34495e; color: #fff")
        self.__hlayout.addWidget(self.exit_btn)
        self.exit_btn.clicked.connect(self.__on_exit_clicked)

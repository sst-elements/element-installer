...
//#define STUPID_DEBUG 
        ...
        public: // functions
            ...
            {
                "toCPU", "Connection towards the processor (directly to the proessor, or down the chain in the direction of the processor)", {
                    "memEvent", ""}
            },
            {
                "toMem", "If 'terminal' is 0 (i.e. this is not the last cube in the chain) then this port connects to the next cube.", {
                    "memEvent", ""}
            },
            )

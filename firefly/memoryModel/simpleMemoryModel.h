...
#include "detailedUnit.h"
    ...
    public:
        void init(int _slot, Work *_work = nullptr) {
            callback = nullptr;
            unit = nullptr;
            slot = _slot;
            work = _work;
        ...
        void init(UnitBase *_unit, UnitBase *_srcUnit = nullptr) {
            callback = nullptr;
            unit = _unit;
            srcUnit = _srcUnit;
            work = nullptr;
...
public:
    ...
    SimpleMemoryModel(Component *comp, Params &params) :
        MemoryModel(comp), m_hostCacheUnit(nullptr), m_busBridgeUnit(nullptr) {
    ...
    void schedResume(SimTime_t delay, UnitBase *unit, UnitBase *srcUnit = nullptr) {
        SelfEvent *ev = m_eventHeap.alloc();

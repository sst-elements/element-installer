...
namespace SST {
    namespace SimpleElementExample {
        ...
        simpleLookupTableComponent::simpleLookupTableComponent(SST::ComponentId_t id,
                                                               SST::Params &params) : Component(
            id) {
            char buffer[128] = {0};
            ...
            if (!fname.empty()) {
                ...
                if (0 != ret)
                    out.fatal(CALL_INFO, 1,
                              "Unable to load lookup table. stat(%s) failed with code %d\n",
                              fname.c_str(), errno);
                ...
                sregion = getGlobalSharedRegion("SimpleLookupTable", tableSize,
            ...
            registerClock("1GHz", new Clock::Handler<simpleLookupTableComponent>(this,
                                                                                 &simpleLookupTableComponent::tick));
        }

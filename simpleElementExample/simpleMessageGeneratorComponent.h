...
namespace SST {
    namespace SimpleMessageGeneratorComponent {
        ...
        public:
            ...
            {
                "remoteComponent", "Sets the link for the message component, message components talk to each other exchanging simple messages", {
            ...
            void finish() {
                fprintf(stdout, "Component completed at: %"
                PRIu64
                " milliseconds\n",
        ...
        private:
            ...
            simpleMessageGeneratorComponent(
                const simpleMessageGeneratorComponent &); // do not implement

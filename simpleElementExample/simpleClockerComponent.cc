...
namespace SST {
    namespace SimpleClockerComponent {
        ...
        simpleClockerComponent::simpleClockerComponent(ComponentId_t id, Params &params) :
            ...
            registerClock("5 ns", new Clock::Handler<simpleClockerComponent, uint32_t>(this,
                                                                                       &simpleClockerComponent::Clock2Tick,
                                                                                       222));

            // Third Clock (15ns)
            std::cout << "REGISTER CLOCK #3 at 15 ns" << std::endl;
            Clock3Handler = new Clock::Handler<simpleClockerComponent, uint32_t>(this,
                                                                                 &simpleClockerComponent::Clock3Tick,
                                                                                 333);
            tc = registerClock("15 ns", Clock3Handler);

            // Create the OneShot Callback Handlers
            callback1Handler = new OneShot::Handler<simpleClockerComponent, uint32_t>(this,
                                                                                      &simpleClockerComponent::Oneshot1Callback,
                                                                                      456);
            callback2Handler = new OneShot::Handler<simpleClockerComponent>(this,
                                                                            &simpleClockerComponent::Oneshot2Callback);
        }

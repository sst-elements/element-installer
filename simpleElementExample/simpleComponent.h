...
namespace SST {
    namespace SimpleComponent {
        ...
        public:
            ...
            { "workPerCycle", "Count of busy work to do during a clock tick.", nullptr },
            { "commFreq", "Approximate frequency of sending an event during a clock tick.", nullptr },
            ...
            {
                "Nlink", "Link to the simpleComponent to the North", {
                    "simpleComponent.simpleComponentEvent", ""}
            },
            {
                "Slink", "Link to the simpleComponent to the South", {
                    "simpleComponent.simpleComponentEvent", ""}
            },
            {
                "Elink", "Link to the simpleComponent to the East", {
                    "simpleComponent.simpleComponentEvent", ""}
            },
            {
                "Wlink", "Link to the simpleComponent to the West", {
                    "simpleComponent.simpleComponentEvent", ""}
            }
            )

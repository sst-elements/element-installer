...
simpleStatisticsComponent::simpleStatisticsComponent(ComponentId_t id, Params &params) :
    ...
    registerClock("1 ns", new Clock::Handler<simpleStatisticsComponent>(this,
                                                                        &simpleStatisticsComponent::Clock1Tick));
    ...
    stat7_U32_NOTUSED = registerStatistic<uint32_t>("stat5_U32",
                                                    "5");   // This registration will return the previously registered stat

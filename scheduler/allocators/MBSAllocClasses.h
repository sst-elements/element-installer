    ...
    namespace Scheduler {
        ...
        public:
            ...
            std::set<MeshLocation *, MeshLocation> *processors() {
                ...
                std::set < MeshLocation * ,
                    MeshLocation > *processors = new std::set<MeshLocation *, MeshLocation>(
                        *MLComp);
            ...
            std::string toString() {
                ...
                ret << "Block[" << dimension->dims[0] << "x" << dimension->dims[1] << "x"
                    << dimension->dims[2] << "]@" << location->toString();
                return ret.str();
            }
        };

...
namespace SST {
    namespace Scheduler {
        ...
        public:
            ...
            SchedChange(unsigned long intime, Job *inj, bool end, const Machine &mach,
                        SchedChange *inpartner = nullptr);
        ...
        private:
            ...
            unsigned long findTime(std::set<SchedChange *, SCComparator> *sched, Job *Job,
                                   unsigned long time);
        ...
        public:
            ...
            unsigned long zeroCase(std::set<SchedChange *, SCComparator> *sched, Job *filler,
                                   unsigned long time);
            ...
            public:
                ConservativeManager(StatefulScheduler *inscheduler, const Machine &mach) : Manager(
                    mach) {
            ...
            protected:
                ...
                int *numSBF;
            public:
                PrioritizeCompressionManager(StatefulScheduler *inscheduler, JobComparator *comp,
                                             int infillTimes, const Machine &mach);

                PrioritizeCompressionManager(PrioritizeCompressionManager *inmanager,
                                             std::set<Job *, JobComparator> *inbackfill,
                                             const Machine &mach);
                ...
                PrioritizeCompressionManager *copy(std::vector<Job *> *running,
            ...
            public:
                ...
                DelayedCompressionManager(DelayedCompressionManager *inmanager,
                                          std::set<Job *, JobComparator> *inbackfill,
                                          const Machine &mach);
                ...
                DelayedCompressionManager *copy(std::vector<Job *> *running,
                                                std::vector<Job *> *intoRun);
            ...
            protected:
                ...
                int bftimes;
            public:
                EvenLessManager(StatefulScheduler *inscheduler, JobComparator *comp,
                                int infillTimes, const Machine &mach);

                EvenLessManager(EvenLessManager *inmanager,
                                std::set<Job *, JobComparator> *inbackfill, const Machine &mach);

                void deepCopy(std::set<SchedChange *, SCComparator> *from,
                              std::set<SchedChange *, SCComparator> *to,
                              std::map<Job *, SchedChange *, JobComparator> *toJ);
...
//                        int results;
            ...
            StatefulScheduler(StatefulScheduler *insched,
                              std::set<SchedChange *, SCComparator> *inestSched, Manager *inheart,
                              std::map<Job *, SchedChange *, StatefulScheduler::JobComparator> *inJobToEvents,
                              const Machine &mach);

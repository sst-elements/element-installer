...
namespace SST {
    namespace n_Bank {
        ...
        public:
            ...
            { "numChannels", "Total number of channels per DIMM", nullptr },
            { "numPChannelsPerChannel", "Total number of channels per pseudo channel (added to support HBM)", nullptr },
            { "numRanksPerChannel", "Total number of ranks per (p)channel", nullptr },
            ...
            { "boolPrintCmdTrace", "Print a command trace", nullptr },
            { "strCmdTraceFile", "Filename to print the command trace, or - for stdout", nullptr },
            { "boolAllocateCmdResACT", "Allocate space in DeviceDriver Res Q for ACT Cmds", nullptr },
            { "boolAllocateCmdResREAD", "Allocate space in DeviceDriver Res Q for READ Cmds", nullptr },
            { "boolAllocateCmdResREADA", "Allocate space in DeviceDriver Res Q for READA Cmds", nullptr },
            { "boolAllocateCmdResWRITE", "Allocate space in DeviceDriver Res Q for WRITE Cmds", nullptr },
            { "boolAllocateCmdResWRITEA", "Allocate space in DeviceDriver Res Q for WRITEA Cmds", nullptr },
            { "boolAllocateCmdResPRE", "Allocate space in DeviceDriver Res Q for PRE Cmds", nullptr },
            { "boolUseRefresh", "Whether to use REF or not", nullptr },
            { "boolDualCommandBus", "Whether to use dual command bus (added to support HBM)", nullptr },
            { "boolMultiCycleACT", "Whether to use multi-cycle (two cycles) active command (added to support HBM)", nullptr },
            { "nRC", "Bank Param", nullptr },
            { "nRRD", "Bank Param", nullptr },
            { "nRRD_L", "Bank Param", nullptr },
            { "nRRD_S", "Bank Param", nullptr },
            { "nRCD", "Bank Param", nullptr },
            { "nCCD", "Bank Param", nullptr },
            { "nCCD_L", "Bank Param", nullptr },
            { "nCCD_L_WR", "Bank Param", nullptr },
            { "nCCD_S", "Bank Param", nullptr },
            { "nAL", "Bank Param", nullptr },
            { "nCL", "Bank Param", nullptr },
            { "nCWL", "Bank Param", nullptr },
            { "nWR", "Bank Param", nullptr },
            { "nWTR", "Bank Param", nullptr },
            { "nWTR_L", "Bank Param", nullptr },
            { "nWTR_S", "Bank Param", nullptr },
            { "nRTW", "Bank Param", nullptr },
            { "nEWTR", "Bank Param", nullptr },
            { "nERTW", "Bank Param", nullptr },
            { "nEWTW", "Bank Param", nullptr },
            { "nERTR", "Bank Param", nullptr },
            { "nRAS", "Bank Param", nullptr },
            { "nRTP", "Bank Param", nullptr },
            { "nRP", "Bank Param", nullptr },
            { "nRFC", "Bank Param", nullptr },
            { "nREFI", "Bank Param", nullptr },
            { "nFAW", "Bank Param", nullptr },
            { "nBL", "Bank Param", nullptr },
            )
        ...
        private:
            ...
            bool sendCommand(c_BankCommand *x_bankCommandPtr,
                             c_BankInfo *x_bank); // helper method to sendRequest

...
namespace SST {
    namespace n_Bank {
        ...
        public:
            ...
            void finish() {
                printf("Bank %u\n", m_bankNum);
                printf("\tTotal ACT-Cmd received: %"
                PRIu32
                "\n", m_ACTCmdsReceived);
                printf("\tTotal READ-Cmd received: %"
                PRIu32
                "\n", m_READCmdsReceived);
                printf("\tTotal WRITE-Cmd received: %"
                PRIu32
                "\n", m_WRITECmdsReceived);
                printf("\tTotal PRE-Cmd received: %"
                PRIu32
                "\n", m_PRECmdsReceived);
                printf("\t\tTotal CMDs received: %"
                PRIu32
                "\n", (m_ACTCmdsReceived + m_READCmdsReceived + m_WRITECmdsReceived +
                       m_PRECmdsReceived));

...
c_Dimm::c_Dimm(SST::ComponentId_t x_id, SST::Params &x_params) :
    ...
    if (k_boolPowerCalc) {
        ...
        if (!l_found) {
            std::cout
                << "[c_Dimm] Power calculation is enabled, but IDD0 value is missing... exiting"
                << std::endl;
            exit(-1);
        }
        ...
        if (!l_found) {
            std::cout
                << "[c_Dimm] Power calculation is enabled, but IDD2N value is missing... exiting"
                << std::endl;
            exit(-1);
        }
        ...
        if (!l_found) {
            std::cout
                << "[c_Dimm] Power calculation is enabled, but IDD2P value is missing... exiting"
                << std::endl;
            exit(-1);
        }
        ...
        if (!l_found) {
            std::cout
                << "[c_Dimm] Power calculation is enabled, but IDD3N value is missing... exiting"
                << std::endl;
            exit(-1);
        }
        ...
        if (!l_found) {
            std::cout
                << "[c_Dimm] Power calculation is enabled, but IDD4R value is missing... exiting"
                << std::endl;
            exit(-1);
        }
        ...
        if (!l_found) {
            std::cout
                << "[c_Dimm] Power calculation is enabled, but IDD4W value is missing... exiting"
                << std::endl;
            exit(-1);
        }
        ...
        if (!l_found) {
            std::cout
                << "[c_Dimm] Power calculation is enabled, but IDD5 value is missing... exiting"
                << std::endl;
            exit(-1);
        }
        ...
        if (!l_found) {
            std::cout
                << "[c_Dimm] Power calculation is enabled, but nRAS value is missing ... exiting"
                << std::endl;
            exit(-1);
        }
        ...
        if (!l_found) {
            std::cout
                << "[c_Dimm] Power calculation is enabled, but nRP value is missing ... exiting"
                << std::endl;
            exit(-1);
        }
        ...
        if (!l_found) {
            std::cout
                << "[c_Dimm] Power calculation is enabled, but nRFC value is missing ... exiting"
                << std::endl;
            exit(-1);
        }
        ...
        if (!l_found) {
            std::cout
                << "[c_Dimm] Power calculation is enabled, but nBL value is missing ... exiting"
                << std::endl;
            exit(-1);
        }
        ...
        if (!l_found) {
            std::cout
                << "[c_Dimm] Power calculation is enabled, but VDD value is missing ... exiting"
                << std::endl;
            exit(-1);
        }
        ...
        if (!l_found) {
            std::cout
                << "[c_Dimm] Power calculation is enabled, but numDevices value is missing ... exiting"
                << std::endl;
            exit(-1);
        }
    ...
    std::string l_clockFreqStr = (std::string) x_params.find<std::string>(
        "strControllerClockFrequency", "1GHz", l_found);
...
void c_Dimm::updateDynamicEnergy(c_BankCommand *x_bankCommandPtr) {
    ...
    switch (x_bankCommandPtr->getCommandMnemonic()) {
        case e_BankCommandType::ACT:
            l_energy =
                ((k_IDD0 * (k_nRAS + k_nRP)) - ((k_IDD3N * k_nRAS) + (k_IDD2N * (k_nRP)))) * k_VDD *
                k_numDevices; //active and precharge
...
void c_Dimm::finish() {
    ...
    if (k_boolPowerCalc) {
        ...
        double l_totalPower =
            l_actprePower + l_readPower + l_writePower + l_refreshPower + l_backgroundPower;
        std::cout << std::endl;

...
static OTF2_CallbackCode EmberOTF2MPIISendComplete(
    ...
    gen->enQ_wait(*(gen->getEventQueue()), checkReq->second, nullptr);
...
/*
	...
	OTF2_Reader_RegisterGlobalEvtCallbacks( traceReader, traceEvtReader, traceGlobalEvtCallbacks, nullptr );
